...
class leaf(pluginTemplate):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.dut_exe = os.path.join(config['PATH'] if 'PATH' in config else "","leaf")
    ...
    def build(self, isa_yaml, platform_yaml):
      ...
      # for leaf start building the '--isa' argument. the self.isa is dutnmae specific and may not be
      # useful for all DUTs
    ...
    def runTests(self, testList):
	  ...
	  # echo statement.
          if self.target_run:
            ...
            simcmd = 'make -sC ~/git/leaf leaf_sim PROGRAM={0}/out.bin | xxd -c 4 -p > {1}'.format(test_dir, sig_file)
          else:
            simcmd = 'echo "NO RUN"'
          ...
          execute = '@cd {0}; {1}; {2}; {3};'.format(testentry['work_dir'], cmd, bincmd, simcmd)
