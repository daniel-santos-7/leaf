...
# The comparison itself lives in common/compare.sh -- see there for what it
# reports and for DIFF_LIMIT.
compare: run
	@DIFF_LIMIT=$(DIFF_LIMIT) $(COMMON_DIR)/compare.sh \
		$(APP_OUT).leaf.dump $(APP_OUT).spike.signature $(DUMP_SIZE)
