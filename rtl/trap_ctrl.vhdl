...
entity trap_ctrl is
    port (
        ...
        -- The interrupts, out of csrs and already masked there, with their OR
        -- out of trap_decode. Live rather than EX-aligned: an interrupt belongs
        -- to no instruction. encode_mcause needs the three apart to name the
        -- cause, everything else only the OR.
...
begin
    ...
    -- directly. An ecall is the only case left once the eight above it are
    ...
    encode_mcause: process(int_taken_i, swi_taken_i, tmi_taken_i, exi_taken_i,
                           imrd_malgn_i, fetch_fault_i, instr_err_i,
                           ebreak_i, dmld_malgn_i, dmld_fault_i,
    ...
    select_mtval: process(int_taken_i, imrd_malgn_i, fetch_fault_i,
                          instr_err_i, ebreak_i, dmld_malgn_i,
